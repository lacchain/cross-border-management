...
@SqlResultSetMapping(name = "movementResultMapping", classes = {
    @ConstructorResult(targetClass = MovementResult.class, columns = { @ColumnResult(name = "id", type = String.class),
            @ColumnResult(name = "datetime", type= String.class), @ColumnResult(name = "transfer_type"), @ColumnResult(name = "sender_name"), @ColumnResult(name = "receiver_name"),@ColumnResult(name = "amount", type = Float.class),@ColumnResult(name = "amount_received", type = Float.class), @ColumnResult(name = "currency", type = String.class), @ColumnResult(name = "status"), @ColumnResult(name = "dlt_address") }) })
@NamedNativeQueries({
